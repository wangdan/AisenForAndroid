...
public class DefaultHeaderTransformer extends HeaderTransformer {
    ...
    private void setupViewsFromStyles(Activity activity, View headerView) {
        ...
        Drawable bg = styleAttrs.hasValue(R.styleable.PullToRefreshHeader_ptrHeaderBackground_uk)
                ? styleAttrs.getDrawable(R.styleable.PullToRefreshHeader_ptrHeaderBackground_uk)
