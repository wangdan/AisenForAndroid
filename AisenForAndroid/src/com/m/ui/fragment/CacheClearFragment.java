...
//				}
	...
	public static void clearCompress() {
		new WorkTask<Void, Void, Void>() {
			...
			@Override
			public Void workInBackground(Void... params) throws TaskException {
				String appPath = SystemUtility.getSdcardPath() + File.separator + SettingUtility.getStringSetting("root_path");
				String cachePath = appPath + File.separator + SettingUtility.getStringSetting("com_m_common_image") + File.separator +
										"compression";
