...
public class SystemBarTintManager {
	...
	@TargetApi(19)
	public static SystemBarTintManager getInstance(Activity activity) {
		if (activity instanceof BaseActivity) {
			BaseActivity baseActivity = (BaseActivity) activity;
			if (baseActivity.getSystemBarTintManager() != null)
				return baseActivity.getSystemBarTintManager();
		}
		
		SystemBarTintManager systemBarTintManager = new SystemBarTintManager(activity);
		if (activity instanceof BaseActivity) {
			BaseActivity baseActivity = (BaseActivity) activity;
			baseActivity.setSystemBarTintManager(systemBarTintManager);
		}
