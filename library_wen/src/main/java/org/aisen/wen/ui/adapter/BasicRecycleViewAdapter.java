...
public class BasicRecycleViewAdapter<T extends Serializable> extends RecyclerView.Adapter implements IPagingAdapter {
    ...
    private final IPaingView ownerFragment;

    public BasicRecycleViewAdapter(Activity activity, IPaingView ownerFragment, IItemViewCreator<T> itemViewCreator, ArrayList<T> datas) {
