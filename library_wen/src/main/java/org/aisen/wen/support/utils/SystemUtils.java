...
@SuppressLint("SdCardPath") public class SystemUtils {
	...
	public static int getKeyboardHeight(Activity paramActivity) {
		...
		if (height == 0) {
			height = SharedPreferencesUtils.getIntShareData(GlobalContext.getInstance(), "KeyboardHeight", 400);
		}
		else {
			SharedPreferencesUtils.putIntShareData(GlobalContext.getInstance(), "KeyboardHeight", height);
		}
